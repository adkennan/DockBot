...
extern struct FC_String DockBotPrefs_Strings[41];
...
#define MSG_MW_Gadgets (DockBotPrefs_Strings[29].msg)
#define _MSG_MW_Gadgets (DockBotPrefs_Strings+29)
#define MSG_MW_NewGadget (DockBotPrefs_Strings[30].msg)
#define _MSG_MW_NewGadget (DockBotPrefs_Strings+30)
#define MSG_MW_EditGadget (DockBotPrefs_Strings[31].msg)
#define _MSG_MW_EditGadget (DockBotPrefs_Strings+31)
#define MSG_MW_DeleteGadget (DockBotPrefs_Strings[32].msg)
#define _MSG_MW_DeleteGadget (DockBotPrefs_Strings+32)
#define MSG_MW_GadgetUp (DockBotPrefs_Strings[33].msg)
#define _MSG_MW_GadgetUp (DockBotPrefs_Strings+33)
#define MSG_MW_GadgetDown (DockBotPrefs_Strings[34].msg)
#define _MSG_MW_GadgetDown (DockBotPrefs_Strings+34)
#define MSG_MW_ConfigSave (DockBotPrefs_Strings[35].msg)
#define _MSG_MW_ConfigSave (DockBotPrefs_Strings+35)
#define MSG_MW_ConfigTest (DockBotPrefs_Strings[36].msg)
#define _MSG_MW_ConfigTest (DockBotPrefs_Strings+36)
#define MSG_MW_ConfigUse (DockBotPrefs_Strings[37].msg)
#define _MSG_MW_ConfigUse (DockBotPrefs_Strings+37)
#define MSG_DEL_Title (DockBotPrefs_Strings[38].msg)
#define _MSG_DEL_Title (DockBotPrefs_Strings+38)
#define MSG_DEL_Text (DockBotPrefs_Strings[39].msg)
#define _MSG_DEL_Text (DockBotPrefs_Strings+39)
#define MSG_DEL_Buttons (DockBotPrefs_Strings[40].msg)
#define _MSG_DEL_Buttons (DockBotPrefs_Strings+40)
